...
-Vipers
- MVVM+Coordinator
- Ribs (for iOS I consider the most effective pattern)
3) back end
...
1) An example of the operation of the program "Radio of one station", created on the basis of the developed libraries: [https://youtu.be/zGGMTsTkRDE;] (https://youtu.be/zGGMTsTkRDE;)
2) An example of a program that uses Nearby Connections technologies. Technology description: The Nearby platform. An example of the program: [https://youtu.be/qCxOJvoi_Hs;](https://youtu.be/qCxOJvoi_Hs;)
3) An example of working with external hardware sensors via the Bluetooth protocol (BLE). Technology description: Nordic Thingy:52. An example of the program: [https://youtu.be/45JJhplQ-Xs;](https://youtu.be/45JJhplQ-Xs;)
